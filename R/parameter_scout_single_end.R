...
# Version 1.0
#
# Optional parameter-scouting module for single-end data. Advisory only.
#
...
#
#   parameter_scout_single_end()  the scan, and the one most callers want.
...
#
# The sibling parameter_scout_paired_end.R differs only in its defaults and in
...
#'
#' @param scout The list returned by \code{parameter_scout_single_end()}.
...
## --- section: parameter_scout_single_end(), exported -----------------------
...
#' @param original_sRNA_annotation Biotype of pre-annotated ncRNA, or "unknown".
#' @param paired_end_data A boolean indicating if the reads are paired-end.
#'   (Default: FALSE, this being the single-end module.)
...
#'   to paired-end reads, so it is accepted and ignored here.
...
#' \code{parameter_scout_single_end()} and returns a pair of cutoffs. By default
...
#'
#' @param x The list returned by \code{parameter_scout_single_end()}, or its
...
#'
#' @seealso \code{\link{parameter_scout_single_end}}
#' @export
